...
import { ChevronDown, Sparkles, Download, Star, FileText } from 'lucide-react';
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <a 
                ...
                className="px-8 py-4 bg-transparent border border-white/10 text-slate-300 rounded-full font-medium hover:bg-white/5 hover:text-white transition-all flex items-center gap-2"
              >
                <Download size={20} />
              </a>
            </div>
