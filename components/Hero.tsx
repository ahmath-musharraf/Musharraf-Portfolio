      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <a 
                href="#portfolio" 
                className="px-8 py-4 bg-white/5 border border-white/10 text-white rounded-full font-medium hover:bg-white/10 hover:border-white/20 transition-all backdrop-blur-md"
              >
                View Works
              </a>
            </div>
        ...
        >
          <div className="relative w-72 h-72 md:w-96 md:h-96 group">
            ...
            {/* Decorative Element */}
            <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-slate-800 rounded-2xl border border-slate-700 flex items-center justify-center shadow-xl animate-bounce duration-[3000ms]">
